...
class RuntimeServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        $this->app->scoped(Tracer::class, function() {
            $serviceName = env('OTEL_SERVICE_NAME', 'app-workflow-worker');
        ...
        $this->app->scoped(WorkerInterface::class, function() {
            ...
            $workflowTaskQueue = env('WORKFLOW_TASK_QUEUE', WorkerFactoryInterface::DEFAULT_TASK_QUEUE);
            return RuntimeFactory::worker($workerFactory, $tracer, $workflowTaskQueue);
        });
